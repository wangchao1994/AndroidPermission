...
public class AudioDecoder {
    ...
    private boolean open(int defaultSampleRate, int defaultChannelNum, int defaultMaxBufferSize) {
        Log.i(TAG, "open audio decoder: " + defaultSampleRate + ", " + defaultChannelNum + ", " + defaultMaxBufferSize);
        if (mIsOpened) {
            return true;
        }
